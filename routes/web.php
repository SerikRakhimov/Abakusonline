...
Route::get('/item/get_items_main_options/{base}/{p_bs}/{project}/{relip_link_project}/{role}/{relit_id}/{link}/{cd_it_id}/{is_code}/{par_link_id?}/{parent_item_id?}', [ItemController::class, 'get_items_main_options'])
