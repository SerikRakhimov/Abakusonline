...
//    ->name('item.ext_store')
//    ->middleware('auth');
Route::post('/item/ext_store/{base}/{project}/{role}/{usercode}/{relit_id}/{string_current?}/{heading?}/{base_index_page?}/{body_link_page?}/{body_all_page?}/{parent_ret_id?}/{view_link?}/{saveurl_add?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_store'])
    ->name('item.ext_store')
    ->middleware('auth');
...
//    ->middleware('auth');
Route::get('/item/ext_delete_question/{item}/{project}/{role}/{usercode}/{relit_id}/{string_current?}/{heading?}/{base_index_page?}/{body_link_page?}/{body_all_page?}/{parent_ret_id?}/{view_link?}/{saveurl_del?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_delete_question'])
    ->name('item.ext_delete_question')
    ->middleware('auth');

//  Нужно '/{par_link?}', при просмотре ext_show.php подчеркивается главная связь (из item_index.php)
//  Нужно '/{parent_item?}', в ней передается $item_id главной записи item_index (при удалении записи с body)
//Route::delete('/item/ext_delete/{item}/{project}/{role}/{usercode}/{relit_id}/{string_link_ids_current?}/{string_item_ids_current?}/{string_all_codes_current?}/{heading?}/{base_index_page?}/{body_link_page?}/{body_all_page?}/{parent_ret_id?}/{view_link?}/{saveurl_del?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_delete'])
//    ->name('item.ext_delete')
//    ->middleware('auth');
Route::delete('/item/ext_delete/{item}/{project}/{role}/{usercode}/{relit_id}/{string_current?}/{heading?}/{base_index_page?}/{body_link_page?}/{body_all_page?}/{parent_ret_id?}/{view_link?}/{saveurl_del?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_delete'])
    ->name('item.ext_delete')
    ->middleware('auth');
...
Route::get('/item/get_items_main_options/{base}/{p_bs}/{project}/{relip_link_project}/{role}/{relit_id}/{link}/{nolnk}/{cd_it_id}/{is_code}/{par_link_id?}/{parent_item_id?}', [ItemController::class, 'get_items_main_options'])
