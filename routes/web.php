...
Route::get('/item/item_index/{project}/{item}/{role}/{usercode}/{relit_id}/{par_link?}/{string_link_ids_tree?}/{string_item_ids_tree?}/{string_all_codes_tree?}', [ItemController::class, 'item_index'])
...
// "->middleware('auth')" не использовать
Route::get('/item/ext_show/{item}/{project}/{role}/{usercode}/{relit_id}/{heading?}/{body_link_page?}/{body_link_count?}/{body_link_perpage?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_show'])
    ->name('item.ext_show');
//->middleware('auth');

Route::get('/item/ext_create/{base}/{project}/{role}/{usercode}/{relit_id}/{heading?}/{body_link_page?}/{body_link_count?}/{body_link_perpage?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_create'])
...
Route::get('/item/ext_edit/{item}/{project}/{role}/{usercode}/{relit_id}/{heading?}/{body_link_page?}/{body_link_count?}/{body_link_perpage?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_edit'])
    ->name('item.ext_edit')
    ->middleware('auth');
...
Route::post('/item/ext_store/{base}/{project}/{role}/{usercode}/{relit_id}/{heading?}/{body_link_page?}/{body_link_count?}/{body_link_perpage?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_store'])
    ->name('item.ext_store')
    ->middleware('auth');
...
Route::put('/item/ext_edit/{item}/{project}/{role}/{usercode}/{relit_id}/{heading?}/{body_link_page?}/{body_link_count?}/{body_link_perpage?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_update'])
...
Route::get('/item/ext_delete_question/{item}/{project}/{role}/{usercode}/{relit_id}/{heading?}/{body_link_page?}/{body_link_count?}/{body_link_perpage?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_delete_question'])
    ->name('item.ext_delete_question')
    ->middleware('auth');

Route::delete('/item/ext_delete/{item}/{project}/{role}/{usercode}/{relit_id}/{heading?}/{body_link_page?}/{body_link_count?}/{body_link_perpage?}/{par_link?}/{parent_item?}', [ItemController::class, 'ext_delete'])
