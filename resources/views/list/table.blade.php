        ...
        'prev_body_all_page'=>$body_all_page,
            ...
            @if($item_find)
                <center>
                    ...
                    @include('view.img',['item'=>$item_find, 'size'=>"medium", 'var_percent'=>"50", 'border'=>true, 'filenametrue'=>false, 'link'=>true, 'img_fluid'=>false, 'card_img_top'=>false, 'title'=>$item->name()])
