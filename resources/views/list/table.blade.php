                       ...
                       class="card-link" title="{{$item->name()}}">
                        ...
                        @if($item_find)
                            <td>
                                ...
                                {{--                                'string_link_ids_current' => $string_link_ids_current,--}}
                                {{--                                'string_item_ids_current' => $string_item_ids_current,--}}
                                @include('view.img',['item'=>$item_find, 'size'=>"medium", 'width'=>"40%", 'filenametrue'=>false, 'link'=>true, 'img_fluid'=>true, 'card_img_top'=>false, 'title'=>$item->name()])
                            </td>
                        @endif
                </tr>
            @endforeach
...
{{--                    </a>--}}
            ...
            @if($item_find)
                <center>
                    @include('view.img',['item'=>$item_find, 'size'=>"medium", 'width'=>"40%", 'filenametrue'=>false, 'link'=>true, 'img_fluid'=>false, 'card_img_top'=>false, 'title'=>$item->name()])
                </center>
            @endif
            <br>
        @endforeach
