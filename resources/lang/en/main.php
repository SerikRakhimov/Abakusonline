...
return [
    ...
    */
    ...
    'all_projects' => 'Available projects',
    'all_project' => 'Available project',
    'all_links' => 'All links',
...
//    'access' => 'Access',
    ...
    'parent_is_nc_related' => 'Calculated from the associated field (parent_is_parent_related = true, on-screen calculation, reference values output)',
    'parent_nc_related_link_id' => 'link_id (parent_is_parent_related = true, on-screen calculation, outputting values from the directory)',
    'parent_is_sets_calc' => 'Base is calculated by assignments',
    ...
    'ua_cl_fn_count' => 'Calculation Count() _ except assignments',
    'ua_cl_fn_sum' => 'Calculation Sum() _ except assignments',
    ...
    'parent_is_base_link' => 'Base reference',
    ...
    'is_base_required' =>'Required (for lists and numbers, if $base->is_required_lst_num_str_txt_img_doc = false',
    ...
    'no_external_role_check_mark' => 'No external user mark',
    'is_default_view_spisok' => 'Default display type List',
    'is_default_view_cards' => 'By default, view Cards',
    'is_default_view_newspaper' => 'By default, the Newspaper view',
    'is_default_allsort_datecreate' => 'Default, "all links," sorted by creation date',
    ...
    'parent_is_checking_history' => 'Availability of history-based data entry (links)',
    'parent_is_checking_empty' => 'Data entry availability based on data occupancy check (links)',
    'is_parent_checking_history' => 'Availability of history-based data entry (rolis)',
    'is_parent_checking_empty' => 'Data entry availability based on data occupancy check (rolis)',
    'info_years' => 'years',
    'info_months' => 'months',
    'info_days' => 'days',
    'info_hours' => 'hours',
    'info_minutes' => 'minutes',
    'entry_minutes' => 'Limit in minutes for updating/deleting data (number of minutes, 0 - unrestricted, bases)',
    'en_min_desc' => 'Limit in minutes for updating/deleting data (explanation, bases)',
    'is_minutes_entry' => 'Limit in minutes for updating/deleting data (robas)',
    'title_en_min' => 'Limit in minutes for updating/deleting data',
    'lifetime_minutes' => '"Lifetime" records (number of minutes, 0 - unrestricted)',
    'lt_min_desc' => '"Lifetime" records (explanation)',
    'title_lt_min' => '"Lifetime" records',
    'is_empty' => 'Empty',
