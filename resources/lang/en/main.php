...
//    'access' => 'Access',
    ...
    'is_default_tst_lst' => 'Default tree structure (link = null, for base_index.php)',
    'is_tst_enable' => 'Tree structure (link = null, for base_index.php)',
    'parent_is_tst_link' => 'For tree structure (link = null, for base_index.php)',
    'is_cus_enable' => 'Current user entries (link = current user, for base_index.php)',
    'parent_is_cus_link' => 'For the current user (link = current user, for base_index.php)',
];
