...
//    'access' => 'Қатынасу',
    ...
    'is_mnmn_base_enable' => 'Негізгі мәзірдегі Негізді көрсету',
    'is_mnmn_base_enable_rule' => 'Осы нұсқада «Басты мәзірдегі Негізді көрсету» белгісін алып тастау қажет («Тізімдегі Негізді жасау», «Тізімдегі Негіздерді оқу», «Тізімдегі Негіздерді түзету», «Тізімдегі Негіздерді жою»)',
