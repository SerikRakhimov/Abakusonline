...
return [
    ...
    */
    ...
    'please_follow' => 'Орындауыңызды өтінемін:',
    'or' => 'немесе',
    'used' => 'Пайдаланылуда',
    ...
    'all_projects' => 'Қол жетімді жобалар',
    'all_project' => 'Қол жетімді жоба',
    'all_links' => 'Барлық байланыстар',
    'all_fields' => 'Барлық өрістер',
...
//    'access' => 'Қатынасу',
    ...
    'setup' => 'Теңшеу',
    'setup_projects' => 'Жобаларды теңшеу',
    ...
    'calculate' => 'Есептеңіз',
    'calculate_all' => 'Барлығын есептеу',
    ...
    'parent_is_nc_related' => 'Байланған өрістен есептеледі (parent_is_parent_related = true, экрандық есептеу кезінде, анықтамалықтан мәндерді шығару)',
    'parent_nc_related_link_id' => 'link_id (parent_is_parent_related = true, экрандық есептеу кезінде, анықтамалықтан мәндерді шығару)',
    'parent_is_sets_calc' => 'Негіз берілумен есептеледі',
    ...
    'default' => 'Әдепкі',
    'is_external' => 'Сыртқы пайдаланушы',
    ...
    'small_history' => 'Т',
    'is_history' => 'Тарихта',
    'to_history' => 'Тарихқа көшіру',
    'from_history' => 'Тарихтан қайтару',
    ...
    'is_list_base_byuser' => 'Пайдаланушы - тізімдегі жазба авторы бойынша сүзу',
    'is_list_base_user_id' => 'Негіздер үшін Пайдаланушылар тізімдегі пайдаланушының user_id бойынша сүзгілеу',
    'is_default_list_base_user_id' => 'Негіздер үшін Пайдаланушылар тізімдегі пайдаланушының user_id бойынша әдепкі сүзгілеу',
    'is_default_list_base_byuser' => 'Әдепкі бойынша тізімдегі жазба авторы - пайдаланушы бойынша сүзу',
    ...
    'is_list_base_user_id_byuser_rule' => 'Бір нұсқаны таңдау керек, не жазба авторы бойынша сүзгілеу керек, не болмаса жазу бойынша сүзгілеу керек, не белгіні мүлдем қоймау керек',
    ...
    'now' => 'Қазір',
    'selected_image' => 'Таңдалған сурет',
    ...
    'ua_replace' => 'Ауыстыру (пайдаланбау) _ Бірінші() есепті пайдалану ұсынылады',
    'ua_cl_gr_first' => 'Бірінші() есеп',
    'ua_cl_gr_last' => 'Соңғы() есеп',
    'ua_cl_fn_avg' => 'Орташа() есептеу _ тағайындаулардан басқа',
    'ua_cl_fn_count' => 'Есептеу Саны() _ тағайындаулардан басқа',
    'ua_cl_fn_sum' => 'Есептеу Сомасы() _ тағайындаулардан басқа',
    ...
    'parent_host_types_must_be_the_same' => 'Ата-аналық негіздердің түрлері бірдей болуы тиіс',
    ...
    'and' => 'Және',
    'current_user' => 'Ағымдық пайдаланушы',
    'my_records' => 'Менің жазбаларым',
    'filter_by_current_user' => 'Ағымдағы пайдаланушы бойынша сүзгі',
    ...
    'instructions_new_version' => 'Интерактивті нұсқаулар',
    'maxcount_lst' => 'Рұқсат етілген жазбалардың ең көп саны (0 - шектеусіз)',
    'is_del_maxcnt_lst' => 'Рұқсат етілген жазбалар санының шегіне жеткенде жазбаларды жою',
    'maxcount_user_id_lst' => 'Пайдаланушы user_id бойынша сүзгі кезінде рұқсат етілген жазбалардың ең көп саны (0 - шектеусіз)',
    ...
    'is_del_max_cnt_message' => 'Жазбалар рұқсат етілген жазбалар санының шегіне жеткенде автоматты түрде жойылады (өзгерту күні бойынша)',
    ...
    'is_show_hist_attr_enable' => 'Жазбаны көргенде «Тарихта» белгісін көрсету',
    'is_edit_hist_attr_enable' => 'Жазбаны көргенде «Тарихта» белгісін түзету',
    'is_list_hist_attr_enable' => 'Тізімдерді қарау кезінде «Тарихта» белгісін көрсету',
    ...
    'is_default_twt_lst' => 'Әдепкі ағаш тәрізді құрылым (main->parent_item = null, base_index.php үшін)',
    'is_twt_enable' => 'Ағаш құрылымы (main->parent_item = null, назар аудару: base_index.php үшін)',
    'parent_is_twt_link' => 'Ағаш құрылымы үшін (main->parent_item = null, назар аудару: base_index.php үшін)',
    'is_default_tst_lst' => 'Әдепкі бойынша, tst құрылым (main->parent_item = null, назар аудару: base_index.php үшін, item_index($link))',
    'is_tst_enable' => 'tst құрылым (main->parent_item = null, назар аудару: base_index.php үшін, item_index($link))',
    'parent_is_tst_link' => 'tst құрылым үшін (main->parent_item = null, назар аудару: base_index.php үшін, item_index($link))',
    'is_cus_enable' => 'Ағымдағы пайдаланушының жазбалары (main->parent_item = ағымдық пайдаланушы, base_index.php үшін, item_index($link))',
    'parent_is_cus_link' => 'Ағымдық пайдаланушы үшін (main->parent_item = ағымдық пайдаланушы, base_index.php үшін, item_index($link))',
    'tree_structure' => 'Ағаш тәрізді құрылым',
    'is_base_required' =>'Қажет (тізімдер мен сандар үшін, егер $base->is_required_lst_num_str_txt_img_doc = жалған болса)',
    ...
    'no_external_role_check_mark' => '«Сыртқы пайдаланушы» белгісі жоқ',
    'is_default_view_spisok' => 'Әдепкі көрініс Тізім',
    'is_default_view_cards' => 'Кәртішкелерді әдепкі қарап шығу',
    'is_default_view_newspaper' => 'Әдепкі көрініс түрі газет болып табылады',
    'is_default_allsort_datecreate' => 'Әдепкі, «барлық байланыстар», құрылған күні бойынша сұрыптау',
    ...
    'parent_is_checking_history' => 'Тарихты тексеру негізінде деректерді енгізудің қолжетімділігі (links)',
    'parent_is_checking_empty' => 'Деректердің толықтығын тексеру негізінде деректерді енгізудің қолжетімділігі (links)',
    'is_parent_checking_history' => 'Тарихты тексеру негізінде деректерді енгізудің қолжетімділігі (rolis)',
    'is_parent_checking_empty' => 'Деректердің толықтығын тексеру негізінде деректерді енгізудің қолжетімділігі (rolis)',
    'info_years' => 'жыл',
    'info_months' => 'ай',
    'info_days' => 'күн',
    'info_hours' => 'сағат',
    'info_minutes' => 'минут',
    'entry_minutes' => 'Деректерді түзету/жою үшін минуттармен шектеу (минуттар саны, 0 - шектеусіз, bases)',
    'en_min_desc' => 'Деректерді түзету/жою үшін минуттармен шектеу (түсініктеме, bases)',
    'is_minutes_entry' => 'Деректерді түзету/жою үшін минуттармен шектеу (robas)',
    'title_en_min' => 'Деректерді түзету/жою үшін минуттармен шектеу',
    'lifetime_minutes' => '«Өмір уақыты» жазбасы (минуттар саны, 0 - шектеусіз)',
    'lt_min_desc' => '«Өмір уақыты» жазбасы (түсініктеме)',
    'title_lt_min' => '«Өмір уақыты» жазбасы',
    'is_empty' => 'Бос',
    'cannot_save_record' => 'Жазбаны сақтау мүмкін емес',
    'is_view_empty_lst' => 'Тізімде «бос» көрсету',
