...
return [
    ...
    */
    ...
    'all_projects' => 'Жалпыға ортақ жобалар',
    'all_project' => 'Жалпыға ортақ жоба',
...
//    'access' => 'Қатынасу',
    ...
    'ch_min_desc' => 'Деректерді түзету/жою үшін минуттармен шектеу (түсініктеме, bases)',
    'is_minutes_entry' => 'Деректерді түзету/жою үшін минуттармен шектеу (robas)',
    'title_min' => 'Деректерді түзету/жою үшін минуттармен шектеу',
    'is_empty' => 'Бос',
