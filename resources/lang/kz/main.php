...
//    'access' => 'Қатынасу',
    ...
    'is_twt_enable' => 'Ағаш құрылымы (main->parent_item = null, base_index.php үшін)',
    'parent_is_twt_link' => 'Ағаш құрылымы үшін (main->parent_item = null, base_index.php үшін)',
    'is_default_tst_lst' => 'Әдепкі бойынша, tst құрылым (main->parent_item = null, base_index.php үшін, item_index($link))',
    'is_tst_enable' => 'tst құрылым (main->parent_item = null, base_index.php үшін, item_index($link))',
    'parent_is_tst_link' => 'tst құрылым үшін (main->parent_item = null, base_index.php үшін, item_index($link))',
