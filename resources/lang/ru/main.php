...
//    'access' => 'Доступ',
    ...
    'maxcount_user_id_lst' => 'Для основы Пользователи максимальное разрешенное количество записей при фильтре по user_id пользователя (0 - без ограничений)',
    ...
    'is_default_tst_lst' => 'По умолчанию, древовидная структура (link = null, для base_index.php)',
    'is_tst_enable' => 'Древовидная структура (link = null, для base_index.php)',
    'parent_is_tst_link' => 'Для древовидной структуры (link = null, для base_index.php)',
    'is_cus_enable' => 'Записи текущего пользователя (link = текущий пользователь, для base_index.php)',
    'parent_is_cus_link' => 'Для текущего пользователя (link = текущий пользователь, для base_index.php)',
];
