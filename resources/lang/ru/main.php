...
//    'access' => 'Доступ',
    ...
    'is_mnmn_base_enable' => 'Показывать Основу в главном меню',
    'is_mnmn_base_enable_rule' => 'В данном варианте у "Показывать Основу в главном меню" нужно убрать пометку (несовместимость с "Создание Основы в списке", "Чтение Основы в списке", "Корректировка Основы в списке", "Удаление Основы в списке")',
];
