...
//    'access' => 'Доступ',
    ...
    'is_twt_enable' => 'Древовидная структура (main->parent_item = null, для base_index.php)',
    'parent_is_twt_link' => 'Для древовидной структуры (main->parent_item = null, для base_index.php)',
    'is_default_tst_lst' => 'По умолчанию, tst структура (main->parent_item = null, для base_index.php, item_index($link))',
    'is_tst_enable' => 'tst структура (main->parent_item = null, для base_index.php, item_index($link))',
    'parent_is_tst_link' => 'Для tst структуры (main->parent_item = null, для base_index.php, item_index($link))',
